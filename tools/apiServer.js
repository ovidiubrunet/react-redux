...
server.post("/courses/", function (req, res, next) {
  ...
  if (error) {
    ...
    req.body.slug = createSlug(req.body.schema.properties.title.default); // Generate a slug for new courses.
    next();
  }
});
...
function validateCourse(course) {
  if (!course.schema.properties.title.default) return "Title is required.";
  return "";
}
